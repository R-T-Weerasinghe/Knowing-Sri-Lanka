...
function img_click(n){
  if(n == 1){
    if(blocks_clicked_state[n - 1]){
        ...
        img_btns[0].src= "./imgs/vacations-yellow.png";
  ...
  if(n == 2){
    if(blocks_clicked_state[n - 1]){
        ...
        img_btns[1].src= "./imgs/tours-yellow.png";
  ...
  if(n == 3){
    if(blocks_clicked_state[n - 1]){
        ...
        img_btns[2].src= "./imgs/hotels-yellow.png";
  ...
  if(n == 4){
    if(blocks_clicked_state[n - 1]){
        ...
        img_btns[3].src= "./imgs/cars-yellow.png";
...
function make_all_imgs_green(){
    ...
    img_btns[0].src= "./imgs/vacations-green.png";
    img_btns[1].src= "./imgs/tours-green.png";
    img_btns[2].src= "./imgs/hotels-green.png";
    img_btns[3].src= "./imgs/cars-green.png";
